...
var Grid = FC.Grid = Class.extend(ListenerMixin, MouseIgnorerMixin, {
	...
	fabricateHelperEvent: function(eventLocation, sourceSeg) {
		...
		fakeEvent.className = (fakeEvent.className || []).concat('fc-helperMain');
...
Grid.mixin({
		...
		var dragListener = this.segDragListener = new HitDragListener(view, {
			...
			hitOver: function(hit, isOrig, origHit) {
				...
				if (dropLocation && (dragHelperEls = view.renderDrag(dropLocation, seg))) {
					...
					mouseFollower.hide(); // if the subclass is already using a mock event "helperMain", hide our own
				}
				else {
					mouseFollower.show(); // otherwise, have the helperMain follow the mouse (no snapping)
				}
	...
	// A truthy returned value indicates this method has rendered a helperMain element.
...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	helperEls: null, // set of cell skeleton elements for rendering the mock event "helperMain"
	...
	renderDrag: function(eventLocation, seg) {
		...
		// if a segment from the same calendar but another component is being dragged, render a helperMain event
	...
	// Renders a mock "helperMain" event. `sourceSeg` is the associated internal segment object. It can be null.
	renderHelper: function(event, sourceSeg) {
		...
		this.rowEls.each(function(row, rowNode) {
			...
			var skeletonEl = $('<div class="fc-helperMain-skeleton"><table/></div>'); // will be absolutely positioned
			var skeletonTop;
	...
	// Unrenders any visual indication of a mock helperMain event
	unrenderHelper: function() {
		if (this.helperEls) {
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	// A returned value of `true` signals that a mock "helperMain" event has been rendered.
	renderDrag: function(eventLocation, seg) {

		if (seg) { // if there is event information for this drag, render a helperMain event

			// returns mock event elements
			// signal that a helperMain has been rendered
	...
	// Renders a mock "helperMain" event. `sourceSeg` is the original segment object and might be null (an external drag)
	renderHelper: function(event, sourceSeg) {
		return this.renderHelperSegs(this.eventToSegs(event), sourceSeg); // returns mock event elements
	},


	// Unrenders any mock helperMain event
	unrenderHelper: function() {
	...
	renderSelection: function(span) {
		if (this.view.opt('selectHelper')) { // this setting signals that a mock helperMain event should be rendered
...
TimeGrid.mixin({
	...
	renderContentSkeleton: function() {
			...
			cellHtml +=
				'<td>' +
					'<div class="fc-content-col">' +
						'<div class="fc-event-container fc-helperMain-container"></div>' +
						'<div class="fc-event-container"></div>' +
		...
		this.helperContainerEls = skeletonEl.find('.fc-helperMain-container');
		this.fgContainerEls = skeletonEl.find('.fc-event-container:not(.fc-helperMain-container)');
...
var basicDayGridMethods = {
	...
	// Affects helperMain-skeleton and highlight-skeleton rows.
	renderIntroHtml: function() {
		var view = this.view;
...
var agendaTimeGridMethods = {
	...
	// Affects content-skeleton, helperMain-skeleton, highlight-skeleton for both the time-grid and day-grid.
	renderIntroHtml: function() {
		var view = this.view;
