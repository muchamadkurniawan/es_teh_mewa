...
func (repository *PembelianRespositoryImpl) DeletePembelian(ctx context.Context, tx *sql.Tx, id int) error {
...
func (repository *PembelianRespositoryImpl) FindByIdPembelian(ctx context.Context, tx *sql.Tx, id int32) (entity.Pembelian, error) {
	var pembelian entity.Pembelian
	SQL := "SELECT id, id_user, id_bahan_baku, tanggal, biaya, use_pembelian FROM pembelian WHERE id = ? LIMIT 1;"
...
func (repository *PembelianRespositoryImpl) FindByAllPembelian(ctx context.Context, tx *sql.Tx) ([]entity.Pembelian, error) {
	var pembelian []entity.Pembelian
	SQL := "SELECT id, id_user, id_bahan_baku, tanggal, jumlah, biaya, use_pembelian FROM pembelian;"
